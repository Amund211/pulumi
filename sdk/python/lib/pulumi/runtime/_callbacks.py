...
_STATE_MIGRATION_CALLBACK_GUIDANCE = (
    ...
    def register_state_migration(
        ...
        async def cb(s: bytes) -> Message:
            ...
            with _callback_restrictions(
                f"the state migration callback for {request.urn!r}",
                allow_provider_functions=False,
                guidance=_STATE_MIGRATION_CALLBACK_GUIDANCE,
            ):
